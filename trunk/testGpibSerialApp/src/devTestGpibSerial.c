...
{
  /* Param 0, */
  {&DSET_BO, GPIBIFC|GPIBEOS, IB_Q_LOW, 0, 0, 0, 0, 0, 0, 0, 0, 0, '\n'},
  /* Param 1, */
  {&DSET_BO, GPIBREN|GPIBEOS, IB_Q_LOW, 0, 0, 0, 0, 0, 0, 0, 0, 0, '\n'},
  /* Param 2, */
  {&DSET_BO, GPIBDCL|GPIBEOS, IB_Q_LOW, 0, 0, 0, 0, 0, 0, 0, 0, 0, '\n'},
  /* Param 3, */
  {&DSET_BO, GPIBLLO|GPIBEOS, IB_Q_LOW, 0, 0, 0, 0, 0, 0, 0, 0, 0, '\n'},
  /* Param 4, */
  {&DSET_BO, GPIBSDC|GPIBEOS, IB_Q_LOW, 0, 0, 0, 0, 0, 0, 0, 0, 0, '\n'},
  /* Param 5, */
  {&DSET_BO, GPIBGTL|GPIBEOS, IB_Q_LOW, 0, 0, 0, 0, 0, 0, 0, 0, 0, '\n'},
  /* Param 6, */
  {&DSET_BO, GPIBRESETLNK|GPIBEOS, IB_Q_LOW, 0, 0, 0, 0, 0, 0, 0, 0, 0, '\n'},

  /* Param 7, */
  {&DSET_LI, GPIBSRQHANDLER|GPIBEOS, IB_Q_LOW, 0,  0, 0, 0, 0, 0, 0, 0, 0, '\n'},
  /* Param 8 */
  {&DSET_LO, GPIBWRITE|GPIBEOS, IB_Q_LOW, 0, "DESE %ld\n", 0, 20, 0, 0, 0, 0, 0, '\n'},
  /* Param 9 */
  {&DSET_LO, GPIBWRITE|GPIBEOS, IB_Q_LOW, 0, "*ESE %ld\n", 0, 20, 0, 0, 0, 0, 0, '\n'},
  /* Param 10 */
  {&DSET_LO, GPIBWRITE|GPIBEOS, IB_Q_LOW, 0, "*SRE %ld\n", 0, 20, 0, 0, 0, 0, 0, '\n'},
  /* Param 11 */
  ...
  /* Param 17 */
  {&DSET_SI, GPIBREADW|GPIBEOS, IB_Q_LOW, "*IDN?\n", 0, 0, 200, readString, 0, 0, 0, 0, '\n'},
  /* Param 18, */
  {&DSET_BO, GPIBCMD|GPIBEOS, IB_Q_LOW, "XXXJUNK\n",  0, 0, 0, 0, 0, 0, 0, 0, '\n'}
};
